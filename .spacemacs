...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Iosevka Haskell"
                               :size 15
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)

...
(use-package shackle
  ...
  (setq shackle-rules '((helpful-mode :align below :select t)
                        (help-mode :align below :select t)
                        (compilation-mode :same t)
                        (magit-status-mode :select t :align below :size 0.6)
                        (magit-revision-mode :select t :align below :size 0.6)
                        (magit-log-mode :select t :align below)
                        (apropos-mode :align below :select t)

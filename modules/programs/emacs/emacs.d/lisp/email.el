...
(defun kenran/notmuch-search-mark-read ()
...
(defun kenran/notmuch-search-delete-mail ()
...
(defun kenran/notmuch-show-delete-mail ()
...
(use-package notmuch
  ...
  (:map notmuch-show-mode-map
        ("d" . kenran/notmuch-show-delete-mail)
        :map notmuch-search-mode-map
        ("d" . kenran/notmuch-search-delete-mail)
        ("u" . kenran/notmuch-search-mark-read)))

...
(use-package emacs
  ...
  (leader
    ...
    "q k" '(save-buffers-kill-emacs :which-key "quit")
...
(leader "t l" '(my/toggle-line-numbers :which-key "line numbers"))
#+end_src
...
* Visualized keybindings with =which-key=
...
(use-package org
  ...
  (local-leader :keymaps 'org-mode-map "o" 'hydra-org/body)
  :bind
  (:map org-mode-map
        ("C-'" . nil)))
#+end_src

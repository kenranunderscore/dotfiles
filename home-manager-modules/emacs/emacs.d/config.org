...
(defhydra hydra-org (:hint nil)
  "\n
  Common commands to navigate and use in org-mode.\n
  ^^forward                    ^^backward
  ---------------------------------------------------------
  _n_:   next visible header   _p_:   previous visible header
  _N_:   next sibling header   _P_:   previous sibling header
  _b_:   next block            _B_:   previous block
...
(use-package org
  ...
  :bind (("C-t o a" . org-agenda)
         ("C-t o c" . org-capture)
         ("C-t o t" . my/capture-todo)
         ("C-t o l" . org-store-link)
         ("C-t o f" . org-cycle-agenda-files)))
#+end_src
...
(defhydra hydra-multiple-cursors (:hint nil)
  ...
  ----------------------------------------------
  [_n_]   next    [_p_]   next    [_l_]   edit lines
  [_N_]   skip    [_P_]   skip    [_a_]   mark all
  [_M-n_] unmark  [_M-p_] unmark  [_r_]   mark by regexp
  [_w_]   word    [_W_]   word    [_M-w_] all words
  ^^              ^^              [_C-w_] words in defun
"

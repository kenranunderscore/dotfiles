...
(defun kenran/switch-font (font)
  ...
  (let* ((attrs (alist-get font kenran/font-alist))
         ...
         (org-height (or (plist-get attrs :org-height) 0.9))
...
(defface kenran/mode-line-inactive-reversed
  (let ((fg (face-attribute 'mode-line-inactive :background))
        (bg (face-attribute 'mode-line-inactive :foreground)))
    `((t :foreground ,fg :background ,bg)))
  "Reversed `mode-line-inactive' face."
  :group 'kenran/faces)

(defmacro kenran/with-active-face (face)
  `(if (mode-line-window-selected-p)
       ,face
     'kenran/mode-line-inactive-reversed)) 

    ...
    (let ((fg (face-attribute 'default :foreground))
     ...
     (cond
      ((eq evil-state 'insert)
       (propertize " INSERT " 'face `(:foreground ,bg :background ,error-fg)))
      ((eq evil-state 'normal)
       (propertize " NORMAL " 'face `(:foreground ,bg :background ,fg)))
      ((eq evil-state 'motion)
       (propertize " MOTION " 'face `(:foreground ,bg :background ,fg)))
      ((eq evil-state 'visual)
       (propertize " VISUAL "
                   'face
                   `(:foreground ,bg :background ,(face-attribute 'font-lock-function-name-face :foreground))))
      ((eq evil-state 'emacs)
       (propertize " EMACS "
                   'face
                   `(:foreground ,bg :background ,(face-attribute 'font-lock-keyword-face :foreground))))
      (t "        "))))

...
to add =:defer t= to a =use-package= call.
...
(keymap-global-set "C-. t l" 'kenran/toggle-line-numbers)
#+end_src
...
(with-eval-after-load 'haskell
  ...
  (keymap-set interactive-haskell-mode-map "C-c e p" 'haskell-goto-previous-error)
...
(keymap-global-set "C-. s s" 'hydra-global-zoom/body)
#+end_src

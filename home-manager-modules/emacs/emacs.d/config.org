...
(keymap-global-set "C-. e" 'my/open-init-file)
#+end_src
...
#+begin_src emacs-lisp
(keymap-global-set "C-. t f" 'my/switch-font)
#+end_src
...
#+begin_src emacs-lisp
(keymap-global-set "C-. t t" 'my/switch-theme)
(keymap-global-set "C-. t r" 'my/reload-theme)
#+end_src
...
(use-package multiple-cursors
  ;; FIXME: https://www.reddit.com/r/emacs/comments/121swxh/multiplecursors_error_on_emacs_29060/
  ;; Remove as soon as the bug is fixed somewhere
  :init

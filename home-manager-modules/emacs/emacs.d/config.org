...
Add some globally useful =org= keybindings under =C-t o=, like for
capturing, storing links etc.

#+begin_src emacs-lisp
(keymap-global-set "C-t o a" 'org-agenda)
(keymap-global-set "C-t o c" 'org-capture)
(keymap-global-set "C-t o t"
                   (defun my/capture-todo ()
                     (interactive)
                     (org-capture nil "t")))
(keymap-global-set "C-t o l" 'org-store-link)
(keymap-global-set "C-t o f" 'org-cycle-agenda-files)
#+end_src
